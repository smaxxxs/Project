				...
				<div class="cont_forms">
					...
					<div class="cont_form_login">
						...
						<form:form method="post" action="/userlogin"
							modelAttribute="userlogin" class="loginform">

							<spring:bind path="nickName">
								<form:input required="true" type="text" placeholder="NickName"
									path="nickName" />
							</spring:bind>
					...
					<div class="cont_form_sign_up">
						<a href="#" onclick="ocultar_login_sign_up()"><i
							class="material-icons"></i></a>
						<h2>SIGN UP</h2>
						<form:form method="post" action="/userregister"
							modelAttribute="userregister" class="registerform">
							<form:input required="true" type="text" placeholder="Surname"
								path="surname" />
							<form:input required="true" type="text" placeholder="Name"
								path="name" />
							<form:input required="true" type="text" placeholder="Nick Name"
								path="nickName" title="Your login  to this site" />
							<form:input required="true" type="password"
								pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
								title="   Your password must be at least 6 characters as well as contain at least one uppercase, one lowercase, and one number."
								placeholder="Password etc fgtY62gH" path="password" />
