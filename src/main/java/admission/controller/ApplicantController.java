...
public class ApplicantController {
	...
	public String getApplicant(@SessionAttribute("appNick") String nickName, Model model) {
	...
	public String addNewRequest(@ModelAttribute("applicantScore") Applicant applicant,
	...
	public @ResponseBody String deleteApplicant(@RequestParam(value = "val", required = true) String parse) {
	...
	public @ResponseBody String editApplicant(@RequestParam(value = "id", required = true) String parse,
	...
	public String submit(@RequestParam("photo") MultipartFile file, ModelMap modelMap,
			@SessionAttribute("appNick") String appnick, HttpServletRequest request)
